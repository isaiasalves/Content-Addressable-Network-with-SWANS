...
public class Peer {
	...
	private static final String BOOTSTRAP_HOSTNAME = "ZELL-PC";
	...
	public void directStart(InetAddress nodeHostName, InetAddress nodeIp, int nodePort, String option) {
		RevisedReceive.startServer(nodePort);
		...
		try {
			...
			peerInstance = Peer.getInstance();
			peerInstance.setHostName(nodeHostName.getHostName());
			peerInstance.setIPaddress(nodeIp);
