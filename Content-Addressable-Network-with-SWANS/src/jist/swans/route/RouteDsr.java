...
//    System.out.println("Quantidade de n�s at� o Destino: "+(routeToHere.length-1)+":");
//    //*********************************************************************************** //
//
//    //******************** Adi��o para plotar os n�s at� o destino ********************* //
...
//    System.out.println();
//    //*********************************************************************************** //
//    //cbr.registrar("Quantidade de n�s at� o Destino: "+(routeToHere.length-1));
//    can.registrar(2, ""+(routeToHere.length-1));
                                     ...
                                     long timeout, int numRetransmits)
  {
    ...
    //************************** Adi��o para mostrar as retransmiss�es que ocorreram **************************************** //
    if (numRetransmits > 0)
    {
  ...
  private void SendWithRoute(NetMessage.Ip msg, NetAddress[] route)
  {
    ...
    //****************************** Adi��o para mostrar o tamanho da rota ******************************//
//    System.out.println();
...
//                " to " + ipMsg.getDst());
  ...
  public void send(NetMessage msg)
  {
    if (!(msg instanceof NetMessage.Ip))
    {
      System.out.println("Pacote n�o suportado");
